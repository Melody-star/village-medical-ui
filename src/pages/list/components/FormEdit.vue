      ...
      <div class="form-basic-container">
        <div class="form-basic-item">
          ...
          <t-row class="row-gap" :gutter="[16, 24]">
            <t-col :span="6">
              <t-form-item label="用户类型" name="user_type">
                <t-select
                  ...
                  clearable
                >
                  <t-option value="0" label="用户">用户</t-option>
                  <t-option value="2" label="医院管理员">医院管理员</t-option>
                </t-select>
              </t-form-item>
            </t-col>
            ...
            <t-col :span="8">
              <t-form-item label="openid" name="openid">
                <t-input v-model="formData.openid" :style="{ width: '322px' }" placeholder="请输入openid"></t-input>
              </t-form-item>
            </t-col>
          </t-row>
        </div>
