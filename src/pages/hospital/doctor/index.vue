<template>
      ...
      >
        <t-row>
          <t-col :span="10">
            <t-row :gutter="[16, 24]">
              <t-col>
                <t-form-item label="医生ID" name="status">
                  <t-input
              ...
              <t-col>
                <t-form-item label="医生姓名" name="username">
                  <t-input
  ...
  export default {
      ...
      return {
        ...
        columns: [
          ...
          },
          {
            ...
            width: 200,
            ellipsis: true,
            colKey: 'secondaryDepartment.department_name',
          },
          {
            title: '挂号费',
            width: 200,
            ellipsis: true,
            colKey: 'registration_fee',
          },
          {
            align: 'left',
            fixed: 'right',
    ...
    methods: {
      ...
      addUser() {
        this.$router.push('/hospital/formEdit2');
